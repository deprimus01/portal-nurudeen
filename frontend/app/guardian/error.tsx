...
// Scoped to /guardian - see app/admin/error.tsx for why this file needs to
// exist per role rather than relying on the root app/error.tsx alone.
export default function GuardianError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => {
